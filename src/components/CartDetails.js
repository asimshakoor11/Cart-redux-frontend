...
const CartDetails = () => {
    ...
    useEffect(()=>{
     ...
     const makePayment = async()=>{
        ...
        const response = await fetch("https://cart-redux-backend.vercel.app/api/create-checkout-session",{
            method:"POST",
            headers:headers,
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'>Total Price<span className='ml-2 mr-2'>:</span><span className='text-danger'>Rs: {totalprice}</span></th>
                                                <th className='text-right'><button className='btn btn-success' type='button' onClick={makePayment}>Check Out</button></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                }
